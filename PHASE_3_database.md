# PHASE 3 — Database Migration & Repository

## Prerequisite
Phase 1 & 2 selesai. `go build ./...` sukses.

## Objective
Buat schema database dan semua operasi DB untuk Run.

## Scope
- `db/migrations/001_create_runs.sql`
- `internal/run/repository.go`

---

## Step 3.1 — File: `db/migrations/001_create_runs.sql`
...
## Step 3.2 — File: `internal/run/repository.go`

Definisikan interface dan implementasinya menggunakan `pgx/v5/pgxpool`.
...
// Repository interface — semua operasi DB untuk Run
...
go build ./...
```
Harus sukses. Update checklist di AGENTS.md: Phase 3 ✅
